# Demo_Build_a_Workout_MERN
This is my third project I developed in Coding Dojo. The four key technologies used in this project is full-stack MongoDB, Express, React, Node (MERN). The Purpose of this application is to have a plan whenever you decide to exercise outdoors or at the gym. The scope of the application can be used by anyone ranging from ages 10 or older. The objective is to be creative when building your workout plan to stay in shape using the application.
